...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li data-screen="email-templates-customer-creation"><?php _e('Creación','aiosc')?></li>
        <li data-screen="email-templates-customer-reply"><?php _e('Nueva Respuesta','aiosc')?></li>
        <li class="active" data-screen="email-templates-customer-closure"><?php _e('Solicitud de Cierre','aiosc')?></li>
