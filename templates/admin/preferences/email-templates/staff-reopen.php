...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li data-screen="email-templates-staff-closure"><?php _e('Solicitud de Cierre','aiosc')?></li>
        <li class="active" data-screen="email-templates-staff-reopen"><?php _e('Reapertura','aiosc')?></li>
    </ul>
</div>
