...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        <li class="active" data-screen="email-templates-cron-reminder-queue"><?php _e('Cola','aiosc')?></li>
        <li data-screen="email-templates-cron-reminder-inactivity"><?php _e('Inactividad','aiosc')?></li>
    </ul>
</div>
