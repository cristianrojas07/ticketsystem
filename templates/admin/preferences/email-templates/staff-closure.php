...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        <li data-screen="email-templates-customer-creation"><?php _e('Clientes','aiosc')?></li>
        <li class="active" data-screen="email-templates-staff-creation"><?php _e('Personal','aiosc')?></li>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li data-screen="email-templates-staff-creation"><?php _e('Asignación','aiosc')?></li>
        <li data-screen="email-templates-staff-reply"><?php _e('Nueva Respuesta','aiosc')?></li>
        <li class="active" data-screen="email-templates-staff-closure"><?php _e('Solicitud de Cierre','aiosc')?></li>
        <li data-screen="email-templates-staff-reopen"><?php _e('Reapertura','aiosc')?></li>
    </ul>
</div>
