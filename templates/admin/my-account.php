...
<div class="wrap">
    <div class="aiosc-window">
        <h2 class="page-title"><?php _e('Mi Cuenta','aiosc') ?>
            <span><?php _e('Edita tu cuenta de Ticket System.','aiosc') ?></span></h2>
        <div class="aiosc-toolbar">
            <ul class="aiosc-tabs">
                <li data-screen="general"><?php _e('General','aiosc')?></li>
                <li data-screen="premade-responses"><?php _e('Respuestas Pre-Hechas','aiosc')?></li>
            </ul>
        </div>
