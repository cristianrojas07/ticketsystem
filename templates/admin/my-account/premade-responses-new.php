...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        <li data-screen="premade-responses"><?php _e('Lista','aiosc')?></li>
        <li <?php if(!aiosc_is_premade_response($response)) : ?>class="active"<?php endif; ?> data-screen="premade-responses-new"><?php _e('Añadir Nuevo','aiosc')?></li>
        <?php if(aiosc_is_premade_response($response)) : ?>
...
<table class="form-table">
    ...
    <tr>
        <th><label for="pri-desc"><?php _e('Content','aiosc')?></label>
            <a href="#" class="aiosc-info-tooltip dashicons dashicons-lightbulb"></a>
            <small><?php _e('El contenido de tu respuesta pre-hecha.','aiosc')?> </small>
        </th>
        <td>
            <?php
            wp_editor(
    ...
    <tr>
        <th><label for="dep-active"><?php _e('¿Compartido?','aiosc')?></label>
            <a href="#" class="aiosc-info-tooltip dashicons dashicons-lightbulb"></a>
            <small><?php _e('¿Quieres que otros vean y usen esta respuesta?','aiosc')?> </small>
        </th>
        <td>
    ...
    <tr>
        <th>&nbsp;</th>
        <td>
            <input type="submit" class="button button-primary" id="aiosc-form-submit" value="<?php echo aiosc_is_premade_response($response)?__('Actualizar','aiosc'):__('Guardar','aiosc')?>" />
