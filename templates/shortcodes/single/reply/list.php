...
<div class="aiosc-window aiosc-replies">
    <h2 class="aiosc-title aiosc-title-sm"><?php _e('Respuestas','aiosc') ?>
        <span>
            <?php if($total_replies > 0)
                printf(_n('Hay %s respuesta publicada en este ticket y la última respuesta fue publicada por %s. ','Hay %s respuestas publicadas en este ticket y la última respuesta fue publicada por %s.',
                        $total_replies,'aiosc'),
