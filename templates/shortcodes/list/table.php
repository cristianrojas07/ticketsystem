...
<table class="aiosc-tickets-table">
    ...
    <tr>
        ...
        <th scope="col" class="manage-column column-replies num">
            <div class="dashicons dashicons-format-chat" title="<?php _e('Respuestas','aiosc')?>"></div>
        </th>
                ...
                <td class="column-subject">
                    ...
                    <div class="aiosc-ticket-row-controls">
                        <?php if($ticket->awaiting_reply) : ?>
                            <span class="aiosc-label aiosc-label-reply"><?php _e('Esperando Respuesta', 'aiosc')?></span>
                        <?php endif; ?>
                        <?php if($ticket->closure_requested) : ?>
                            <span class="aiosc-label aiosc-label-closure"><?php _e('Solicitud de Cierre', 'aiosc')?></span>
                        <?php endif; ?>
    ...
    <?php else : ?>
        <tr>
            <td colspan=8 class="aiosc-no-items"><?php _e('No se encontraron tickets.','aiosc')?></td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
