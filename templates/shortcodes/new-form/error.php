...
<div class="aiosc-window">
    <?php if(is_user_logged_in()) : ?>
        <div class="aiosc-form-response error" style="display: block">
            <p>
                <?php _e('<strong>Error:</strong> No tienes permiso para crear nuevos tickets.','aiosc')?>
            </p>
        </div>
    <?php else : ?>
        <div class="aiosc-form-response warning" style="display: block">
            <p>
                <?php _e('Para crear un nuevo ticket, primero debe iniciar sesión con su cuenta.','aiosc')?>
            </p>
        </div>
