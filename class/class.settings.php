...
class aiosc_Settings {
    ...
    private function get_defaults() {
        $settings = array(
            ...
            'cron_autoclose_requested_closure_note'=>__('Ticket cerrado bajo petición.', 'aiosc'), //note for closure on Closure-Requested tickets
            'cron_autoclose_closure_note'=>__('Ticket cerrado por inactividad.', 'aiosc'), //note for closure due to inactivity
            ...
            //email templates
            'email_templates_customer_creation_subject'=>__('[Ticket #{%ticket.id%}] Nuevo ticket creado.', 'aiosc'),
            'email_templates_customer_reply_subject'=>__('[Ticket #{%ticket.id%}] Tienes una nueva respuesta!', 'aiosc'),
            'email_templates_customer_closure_subject'=>__('[Ticket #{%ticket.id%}] Su ticket ha sido cerrado.', 'aiosc'),
            'email_templates_customer_reopen_subject'=>__('[Ticket #{%ticket.id%}] Su ticket es reabierto.', 'aiosc'),
            ...
            'email_templates_staff_creation_subject'=>__('[Ticket #{%ticket.id%}] Has sido asignado a un nuevo ticket.', 'aiosc'),
            'email_templates_staff_reply_subject'=>__('[Ticket #{%ticket.id%}] El cliente publicó una nueva respuesta.', 'aiosc'),
            'email_templates_staff_closure_subject'=>__('[Ticket #{%ticket.id%}] Cierre solicitado por el cliente.', 'aiosc'),
            'email_templates_staff_reopen_subject'=>__('[Ticket #{%ticket.id%}] El cliente ha reabierto este ticket.', 'aiosc'),
            ...
            'email_templates_cron_reminder_inactivity_subject'=>__('[Ticket #{%ticket.id%}] No hemos tenido noticias de usted...', 'aiosc'),
            'email_templates_cron_reminder_queue_subject'=>__('[Ticket #{%ticket.id%}] ¡No nos hemos olvidado de ti!', 'aiosc'),
    ...
    function install() {
        ...
        $this->load_settings();
        aiosc_log('[Instalador de Ticket System] [Configuración] Instalado exitosamente.');
    }
