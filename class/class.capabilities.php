<?php
    class aiosc_Capabilities {
        ...
        public function get_roles() {
            $roles = array(
                ...
                'aiosc_support_op'=>array(
                    'name'=>__('Operador de Tickets','aiosc'),
                    'caps'=>array(
                        'create_ticket'=>true,
                        'close_ticket'=>true,
                        'view_ticket'=>true,
                ...
                'aiosc_exclusive_customer'=>array(
                    'name'=>__('Cliente Exclusivo','aiosc'),
                    'caps'=>array(
                        'create_ticket'=>true,
                        'reply_ticket'=>true,
                        'view_ticket'=>true,
        ...
        function get_role_name($role_id) {
            ...
            if(!array_key_exists($role_id,$roles)) return __('Ninguno','aiosc');
        ...
        function partial_install() {
            ...
            return aiosc_response(2, __('En progreso...', 'aiosc'),
