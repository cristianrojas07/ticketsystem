    ...
    function __construct($id, $data = false) {
        ...
        if($this->data != false) {
            ...
            if(empty($this->data->closure_note))
                $this->data->closure_note = apply_filters('aiosc_closure_note',__('El operador no dejó ninguna nota sobre el cierre.','aiosc'));

            if($this->data->status == 'queue') $this->data->status_name = __('En Cola','aiosc');
            elseif($this->data->status == 'open') $this->data->status_name = __('Abierta','aiosc');
            elseif($this->data->status == 'closed') $this->data->status_name = __('Cerrada','aiosc');
