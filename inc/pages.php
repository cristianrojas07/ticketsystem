    ...
    function init_admin_pages() {
        ...
        if(aiosc_is_user($aiosc_user)) {
            ...
            if(get_option('aiosc_installed') != 'Y' && current_user_can('manage_options')) {
                add_menu_page(__('Ticket System - Finalizar activación','aiosc'),__('AIOSC<br />Finalize Activation','aiosc'),'read','aiosc-list',array($this,'admin_page_sc_install'), 'dashicons-tickets');
            }
            else {
                $new_tickets_count = aiosc_TicketManager::count_new_tickets();
                if($new_tickets_count > 0) {
                    $main_name = sprintf(__('Ticket System %s','aiosc'),'<span class="awaiting-mod count-'.$new_tickets_count.'"><span class="pending-count">'.$new_tickets_count.'</span></span>');
                }
                else {
                    $main_name = __('Ticket System','aiosc');
                }

                add_menu_page(__('Ticket System','aiosc'), $main_name, 'read', 'aiosc-list', array($this,'admin_page_sc_list'),'dashicons-tickets');

                add_submenu_page('aiosc-list',__('Ticket System - Todos los Tickets','aiosc'),__('Todos los Tickets','aiosc'),'read','aiosc-list',array($this,'admin_page_sc_list'));
                if(aiosc_pg('page',false) == 'aiosc-ticket-preview') {
                    add_submenu_page('aiosc-list',__('Ticket System - Vista Previa de Tickets','aiosc'),__('Vista Previa de Tickets','aiosc'),'read','aiosc-ticket-preview',array($this,'admin_page_sc_preview'));
                }
                if($aiosc_user->can('staff')) {
                    add_submenu_page('aiosc-list',__('Ticket System - Mi Cuenta','aiosc'),__('Mi Cuenta','aiosc'),'read','aiosc-account',array($this,'admin_page_sc_account'));
                }
                if((!$aiosc_user->can('staff') && $aiosc_user->can('create_ticket')) || ($aiosc_user->can('staff') && !$aiosc_user->get_meta('aiosc_staff_create_form_disable'))) {
                    add_submenu_page('aiosc-list',__('Ticket System - Crear Nuevo','aiosc'),__('Crear Nuevo','aiosc'),'read','aiosc-new',array($this,'admin_page_sc_new_ticket'));
                }
                do_action('aiosc_admin_menu');

                if($aiosc_user->can('manage_options')) {
                    add_submenu_page('aiosc-list',__('Ticket System - Preferencias','aiosc'),__('Preferencias','aiosc'),'read','aiosc-preferences',array($this,'admin_page_sc_preferences'));
                    add_submenu_page('aiosc-list',__('Ticket System - Herramientas','aiosc'),__('Herramientas','aiosc'),'read','aiosc-tools',array($this,'admin_page_sc_tools'));
                }
