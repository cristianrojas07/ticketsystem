...
function aiosc_get_template_path($template_name, $can_extend = false) {
    ...
    if($can_extend && file_exists(get_stylesheet_directory()."/ticketsystem/$template_name"))
        $file = get_stylesheet_directory()."/ticketsystem/$template_name";
    return $file;
}
...
function aiosc_get_plugin_data() {
    return get_plugin_data(AIOSC_DIR."/ticketsystem.php");
}
